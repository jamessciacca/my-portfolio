        ...
        <section id="landing">
            <div className="max-w-screen-xl p-10 mx-auto">
                ...
                <ul id='socials' className="flex items-center mt-5">
                    ...
                    <li><a href="/MoreAbout" id='contactBtn' className="text-white font-semibold bg-primary hover:bg-primarytrans hover:text-indigo-600 rounded py-2 px-4 border-2 focus:outline-none focus:border-teal-500 transition duration-150 ease-in-out">About Me</a></li>
